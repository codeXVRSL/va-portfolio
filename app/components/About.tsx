      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="about-pin-wrap grid grid-cols-1 gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            <div className="about-pin relative mx-auto h-[520px] w-full max-w-[460px] sm:h-[580px] md:h-[640px]">
              {/* huge italic ornament — anchors the composition (back) */}
              <span className="about-ornament pointer-events-none absolute -left-4 -top-10 z-0 select-none font-display text-[12rem] italic leading-none text-accent/[0.10] sm:-left-6 sm:text-[15rem] md:-left-8 md:-top-14 md:text-[18rem]">
                &amp;
              </span>

              {/* layer 1 — pull-quote card, top-LEFT, back */}
              <div className="about-layer-1 absolute left-0 top-2 z-10 w-[56%] -rotate-[3deg] rounded-[2px] border border-ink/12 bg-cream/85 p-5 shadow-[0_30px_60px_-40px_rgba(43,35,28,0.5)] backdrop-blur-sm sm:w-[58%] sm:p-6">
                <div className="text-[0.55rem] uppercase tracking-[0.32em] text-ink/45 sm:text-[0.6rem]">
                  The promise
                </div>
                <p className="mt-3 font-display text-[1.25rem] italic leading-[1.15] tracking-[-0.01em] text-ink sm:mt-4 sm:text-[1.5rem]">
                  Followers become{' '}
                  <span className="text-accent">clients</span>.
                </p>
              </div>

              {/* layer 3 — credentials card, bottom-LEFT, mid layer */}
              <div className="about-layer-3 absolute bottom-2 left-0 z-20 w-[60%] rotate-[-1.5deg] rounded-[2px] border border-ink/12 bg-paper p-4 shadow-[0_30px_60px_-30px_rgba(43,35,28,0.55)] sm:w-[62%] sm:p-5">
              ...
              {/* layer 2 — portrait card, RIGHT, FRONT (visually dominant) */}
              <div className="about-layer-2 absolute right-0 top-[8%] z-30 w-[66%] rotate-[1.5deg] overflow-hidden rounded-[2px] border border-ink/12 bg-paper shadow-[0_40px_70px_-30px_rgba(43,35,28,0.55)] sm:w-[68%]">
                ...
                <div className="relative aspect-[4/5] w-full overflow-hidden">
                  ...
                  <img
                    ...
                    alt="Jamaica Tinguha"
                    className="absolute inset-0 h-full w-full object-cover object-[center_18%] grayscale-[0.06] saturate-[0.95]"
                  />
                  <span className="pointer-events-none absolute inset-0 bg-gradient-to-t from-ink/60 via-ink/10 to-transparent" />
              ...
              <span className="about-spark absolute right-[18%] bottom-[18%] h-1 w-1 rounded-full bg-ink/40" />
            </div>
          </div>
        </div>
      </div>
